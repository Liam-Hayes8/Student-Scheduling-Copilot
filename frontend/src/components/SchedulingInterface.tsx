...
import { PaperAirplaneIcon, SparklesIcon, CalendarIcon, ClockIcon } from '@heroicons/react/24/outline'
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-sm text-gray-500">
                ({response.data.plans.length} plan{response.data.plans.length !== 1 ? 's' : ''})
              </span>
            </div>
            ...
            <div className="space-y-4">
              {response.data.plans.map((plan, index) => (
                <div key={plan.id} className="border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                    <div className="flex items-center space-x-2 text-sm">
                      ...
                      <span className="font-medium">{formatDate(plan.startDateTime)}</span>
                    </div>
                    <div className="flex items-center space-x-2 text-sm">
                  ...
                  <div className="mt-4 flex space-x-3">
                    ...
                    <button className="px-4 py-2 border border-gray-300 text-gray-700 hover:bg-gray-50 rounded-md text-sm font-medium transition-colors">
                      Modify
                    </button>
                  </div>
                </div>
